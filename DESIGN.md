...
| A poster before the viewer | No iframe, no WebGL and none of the viewer's assets until someone asks for them; a visitor who never touches the map never downloads it. Reaching for the lantern (hover, focus, touch) fetches the viewer's code ahead, and the poster only leaves once the map under it is drawn. |
